...
for i in range(ns, ne+1):
    ...
    ax[0][0].plot(time_cloud_i/1e3, mass_cloud_i/mass_cl_init, label="total", linewidth=linewidth, c="#49b4ab")
    ax[0][0].plot(time_output_i/1e3, mass_out_cloud_i/mass_cl_init, label="exited box", linewidth=linewidth-1, linestyle="--", c="#49b4ab")
